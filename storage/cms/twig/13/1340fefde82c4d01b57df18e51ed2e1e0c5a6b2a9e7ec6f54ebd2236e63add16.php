...
class __TwigTemplate_c65b6f1362215c3593b68bd663a91c7b4aafb62d15d616b0cb94c1329c31ddbe extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["slide"]) {
                ...
                if (((twig_get_attribute($this->env, $this->source, $context["slide"], "button_1_active", [], "any", false, false, false, 20) && twig_get_attribute($this->env, $this->source, $context["slide"], "button_1_text", [], "any", false, false, false, 20)) && twig_get_attribute($this->env, $this->source, $context["slide"], "button_1_url", [], "any", false, false, false, 20))) {
                    ...
                    echo "\"
                                           class=\"btn btn-rounded btn-wt btn-lg mr-10 mb-20 mt-3\">";
                    // line 22
...
<section class=\"section hero-area\">
    <div class=\"hero-slider owl-carousel owl-controls-1\">
        {% for slide in slides %}
            <div class=\"hero-slider-item slider-bg-{{ slide.image_align }}\"
                 data-bg-img=\"{{ slide.image.thumb(1920,900,{'mode':'crop'})}}\"
                style=\"border-radius: 0% 0% 50% 50%;\">
                    <div class=\"hero-overlay-wrapper\">
                        <div class=\"pos-tb-center hero-overlay-inner\">
                            <div class=\"container\">
                                <div class=\"row row-tb-20\">
                                    <div class=\"col-md-12{% if slide.text_align == 'center' %} text-center{% endif %}\">
                                        {% if slide.subtitle %}
                                        <h2 style=\"font-family: 'Kimberlly Regular'; font-size: {{ slide.subtitle_size }}px !important;{% if slide.subtitle_color %} color: {{ slide.subtitle_color }} !important; {% endif %}\"
                                            class=\"mb-10\">{{ slide.subtitle }}</h2>{% endif %}
                                        <h1 style=\"font-family: 'Kimberlly Regular'; font-size: {{ slide.title_size }}px !important;{% if slide.title_color %} color: {{ slide.title_color }} !important; {% endif %}\"
                                            class=\"t-uppercase mb-20\">{{ slide.title }}</h1>
                                        {% if slide.description %}<p{% if slide.description_color %} style=\"color: {{ slide.description_color }} !important;\"{% endif %} class=\"mb-30 color-lighter h4\">{{ slide.description }}</p>{% endif %}
                                        {% if slide.button_1_active and slide.button_1_text and slide.button_1_url %}
                                        <a {% if slide.button_1_color %}style=\"background-color:{{ slide.button_1_color }}; border-color:{{ slide.button_1_color }}; color:#000!important;\" {% endif %}href=\"{{ slide.button_1_url }}\"
                                           class=\"btn btn-rounded btn-wt btn-lg mr-10 mb-20 mt-3\">{{ slide.button_1_text }}</a>
                                        {% endif %}
...
<!-- End Hero Area -->
{% endif %}", "/Users/alexandrefoisy/web sites/vert-boheme/themes/vert-boheme/partials/home-slider/default.htm", "");
    }
}
