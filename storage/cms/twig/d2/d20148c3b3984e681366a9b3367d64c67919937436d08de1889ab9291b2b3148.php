...
class __TwigTemplate_9c2b6de0ded90583b75f0a4e239ad719666c19928d107e307ff4a97d3e0ef4eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<footer>
    ...
    {
        return new Source("<section id=\"contact\" class=\"py-5 craftbg\">
    <div class=\"container\">
        <div class=\"row d-flex justify-content-center\">
            <div class=\"col-xs-12 col-sm-8 \">
                <h2 class=\"h2-responsive text-center\">
...
<footer>
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col\">
                Me suivre :
                <a href=\"{{ this.theme.facebook_url }}\" target=\"_blank\"><i class=\"fab fa-facebook\"></i></a>
                <a href=\"{{ this.theme.instagram_url }} \" target=\"_blank\"><i class=\"fab fa-instagram\"></i></a>
            </div>
        </div>
    </div>
    </section>
...
</footer>", "/Users/alexandrefoisy/web sites/vert-boheme/themes/vert-boheme/partials/footer.htm", "");
    }
}
